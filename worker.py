...
# be sure to modify dockerfile for worker to install python humio library
from humiolib.HumioClient import HumioIngestClient

client = HumioIngestClient(base_url= "https://cloud.community.humio.com", ingest_token="XXXX")
...
def screenshot(taskid, url, private):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            log_data = [f"{data['taskid']}|{data['url']}|{data['title']}|{data['yara_matches']}"]
    ...
    client.ingest_messages(log_data)
